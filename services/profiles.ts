...
/**
 * §5/§6: admin and aft_teacher own member data — role, department, class,
 * club, student_id. Enforced twice: prevent_member_identity_change (0025)
 * blocks the four identity columns for anyone else, and
 * prevent_role_self_escalation (0024) blocks the role change the same way
 * setProfileRole above does. student_id is UNIQUE — a duplicate is a
 * realistic data-entry mistake, mapped to its own message key rather than
